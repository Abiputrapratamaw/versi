...
[[ "$ddMode" == '1' ]] && {
# Tambah variabel untuk Telegram di bagian awal
export TG_BOT=''
export TG_CHAT=''
export TG_MSG=''

WinNoDHCP(){
  echo -ne "for\0040\0057f\0040\0042tokens\00753\0052\0042\0040\0045\0045i\0040in\0040\0050\0047netsh\0040interface\0040show\0040interface\0040\0136\0174more\0040\00533\0040\0136\0174findstr\0040\0057I\0040\0057R\0040\0042Local\0040Ethernet\0042\0047\0051\0040do\0040\0050set\0040EthName\0075\0045\0045j\0051\r\nnetsh\0040\0055c\0040interface\0040ip\0040set\0040address\0040name\0075\0042\0045EthName\0045\0042\0040source\0075static\0040address\0075$IPv4\0040mask\0075$MASK\0040gateway\0075$GATE\r\nnetsh\0040\0055c\0040interface\0040ip\0040delete\0040dns\0040\0042\0045EthName\0045\0042\0040all\r\nnetsh\0040\0055c\0040interface\0040ip\0040add\0040dnsservers\0040name\0075\0042\0045EthName\0045\0042\0040address\0075\00561\00561\00561\00561\0040index\00751\0040validate\0075no\r\nnetsh\0040\0055c\0040interface\0040ip\0040add\0040dnsservers\0040name\0075\0042\0045EthName\0045\0042\0040address\00758\00568\00564\00564\0040index\00752\0040validate\0075no\r\nipconfig\0040\0057flushdns\r\n\r\n" >>'/tmp/boot/net.tmp';
}
...
WinSetPass(){
  echo -ne "net\0040user\0040administrator\0040\0042$tmpWORD\0042\r\nnet\0040user\0040administrator\0040\0057active\0072yes\r\nwmic\0040UserAccount\0040where\0040Name\0075\0047administrator\0047\0040set\0040PasswordExpires\0075FALSE\r\n\r\n" >>'/tmp/boot/net.tmp';
}

WinTG(){
  # Cek koneksi dan kirim notifikasi
  [[ -z "$TG_MSG" ]] && TG_MSG="✅ Windows Ready!\n💻 PC: %ComputerName%\n🌐 IP: $IPv4\n🔑 Pass: $tmpWORD\n🚪 Port: $WinRemote"
  echo -ne "ping\0040\0055n\00405\00408\0568\0568\0568\0040\0076\0040NUL\r\nIF\0040\0045ERRORLEVEL\0045\0040EQU\00400\0040\0050\r\ncurl\0040\0055s\0040\0055X\0040POST\0040https\0072\0057\0057api\0056telegram\0056org\0057bot$TG_BOT\0057sendMessage\0040\0055d\0040chat_id\0075$TG_CHAT\0040\0055d\0040text\0075\0042$TG_MSG\0042\r\n\0051\r\n\r\n" >>'/tmp/boot/net.tmp';
}
  ...
  [[ -n "$tmpWORD" ]] && WinSetPass;
  [[ "$setRDP" == '1' ]] && [[ -n "$WinRemote" ]] && WinRDP
  [[ -n "$TG_BOT" ]] && [[ -n "$TG_CHAT" ]] && WinTG
